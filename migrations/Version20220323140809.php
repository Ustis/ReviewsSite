 ...
 */
final class Version20220323140809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, name VARCHAR(255) NOT NULL, added_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, description VARCHAR(2048) NOT NULL, keywords VARCHAR(1024) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, info VARCHAR(512) NOT NULL, image VARCHAR(512) NOT NULL, PRIMARY KEY(id))');
